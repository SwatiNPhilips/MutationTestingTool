...
ReplaceMinusWithPlus* ReplaceMinusWithPlus::m_Instance = nullptr;
...
ReplaceMinusWithPlus::ReplaceMinusWithPlus()
{
...
bool ReplaceMinusWithPlus::Mutate(std::string& line)
{
	bool result = false;
	cout << "\n ReplaceMinusWithPlus : " << line << "\n";
