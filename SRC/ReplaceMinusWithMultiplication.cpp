...
ReplaceMinusWithMultiplication* ReplaceMinusWithMultiplication::m_Instance = nullptr;
...
ReplaceMinusWithMultiplication::ReplaceMinusWithMultiplication()
{
...
bool ReplaceMinusWithMultiplication::Mutate(std::string& line)
{
	bool result = false;
	cout << "\n ReplaceMinusWithMultiplication : " << line << "\n";
